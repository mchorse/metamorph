...
public class GuiMorphBuilder implements IDropDownListener
{
    ...
    {
        this.parent = parent;
        this.dropDown = new GuiDropDownField(Minecraft.getMinecraft().fontRenderer, this);
    ...
    public void draw(int mouseX, int mouseY, float partialTicks)
    {
        ...
        Minecraft.getMinecraft().fontRenderer.drawStringWithShadow(this.stringBuilder, this.x, this.y + 6, 0xffffff);
    }
}