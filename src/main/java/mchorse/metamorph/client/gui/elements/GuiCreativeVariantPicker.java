...
public class GuiCreativeVariantPicker
{
        ...
        if (this.previous != selected)
        {
            ...
            if (selected != null && selected.variants.size() > 1)
            {
                ...
                if (maxWidth > 0)
                {
                    ...
                    this.scroll = MathHelper.clamp(this.scroll, 0, maxWidth);
                }
            }
        }
    ...
    {
        MorphCell selected = this.morphs.getSelected();
        EntityPlayer player = this.morphs.mc.player;
        ...
        if (selected != null)
        {
            ...
            this.scroll = MathHelper.clamp(this.scroll, 0, maxWidth < 0 ? 0 : maxWidth);
