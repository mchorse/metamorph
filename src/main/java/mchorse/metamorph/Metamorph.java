 ...
 */
@Mod(modid = Metamorph.MOD_ID, name = Metamorph.MODNAME, version = Metamorph.VERSION, updateJSON = "", dependencies = "after:moreplayermodels;required-after:mclib@[%DOMINIONLIB%,)")
